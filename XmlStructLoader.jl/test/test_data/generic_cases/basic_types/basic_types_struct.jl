...
function TestComplexType1(node::XmlStructLoader.LazyNode)
    ...
    return TestComplexType1(node, LazilyInitializedFields.uninit, LazilyInitializedFields.uninit, LazilyInitializedFields.uninit, LazilyInitializedFields.uninit, LazilyInitializedFields.uninit, LazilyInitializedFields.uninit, LazilyInitializedFields.uninit, LazilyInitializedFields.uninit, attribs, false)
end
...
function TestComplexType6(node::XmlStructLoader.LazyNode)
    attribs = XmlStructLoader.lazy_attributes_dict(node)
    return TestComplexType6(node, LazilyInitializedFields.uninit, LazilyInitializedFields.uninit, LazilyInitializedFields.uninit, attribs, false)
end

function TestComplexType6(__lazy_arg_1, __lazy_arg_2, __lazy_arg_3, __xml_attributes = nothing, __validated::Bool = true)
    return TestComplexType6(nothing, convert(String, __lazy_arg_1), convert(Float64, __lazy_arg_2), convert(Union{ZonedDateTime, DateTime}, __lazy_arg_3), __xml_attributes, __validated)
end

function TestComplexType6(; Element_string, Element_double, Element_dateTime, __xml_attributes = nothing, __validated::Bool = true)
    return TestComplexType6(Element_string, Element_double, Element_dateTime, __xml_attributes, __validated)
end

function _init_Element_string(o::TestComplexType6)
    child = XmlStructLoader.lazy_child_with_name(o._node, "Element_string", false)
    isnothing(child) && return nothing
    owner = child.owner
    return GC.@preserve owner XmlStructLoader.parse_xml_node_not_module(child.ptr, String, @__MODULE__, false, nothing)
...
function _init_Element_double(o::TestComplexType6)
    child = XmlStructLoader.lazy_child_with_name(o._node, "Element_double", false)
    isnothing(child) && return nothing
    owner = child.owner
    return GC.@preserve owner XmlStructLoader.parse_xml_node_not_module(child.ptr, Float64, @__MODULE__, false, nothing)
...
function _init_Element_dateTime(o::TestComplexType6)
    child = XmlStructLoader.lazy_child_with_name(o._node, "Element_dateTime", false)
    isnothing(child) && return nothing
    owner = child.owner
    return GC.@preserve owner XmlStructLoader.parse_xml_node_not_module(child.ptr, Union{ZonedDateTime, DateTime}, @__MODULE__, false, nothing)
...
@lazy struct documentType <: AbstractXsdTypes.AbstractXSDComplex
    ...
    @lazy TestElement3::TestComplexType6 = _init_TestElement3
    __xml_attributes::Union{Nothing, Dict{String, String}}
    __validated::Bool
end
...
function documentType(__lazy_arg_1, __lazy_arg_2, __lazy_arg_3, __xml_attributes = nothing, __validated::Bool = true)
    return documentType(nothing, convert(TestComplexType1, __lazy_arg_1), convert(TestSimpleType1, __lazy_arg_2), convert(TestComplexType6, __lazy_arg_3), __xml_attributes, __validated)
end
