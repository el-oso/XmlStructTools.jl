# Correctness check: quick-xml prototype vs the real EzXML-backed loader.

include("loader_quickxml.jl")
...
for (module_dir, xml_files) in test_files
    ...
    for xml_path in xml_files
        ...
        proto_result = QuickxmlLoaderProto.load(xml_path, real_ref)
...
n_fail == 0 || error("$(n_fail) fixtures mismatched between real and quick-xml-prototype loaders")
