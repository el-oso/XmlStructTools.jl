# Correctness check: pugixml prototype vs the real EzXML-backed loader, same approach as
# prototype_xmljl/validate.jl.

include("loader_pugixml.jl")
...
for (module_dir, xml_files) in test_files
    ...
    for xml_path in xml_files
        ...
        proto_result = PugixmlLoaderProto.load(xml_path, real_ref)
...
n_fail == 0 || error("$(n_fail) fixtures mismatched between real and pugixml-prototype loaders")
