module XmlStructPugixmlTests

using ReTest
using XmlStructPugixml

const fixture = joinpath(@__DIR__, "..", "..", "XmlStructLoader.jl", "test", "test_data", "generic_cases", "basic_types.xml")

@testset "read basic_types.xml" begin
...
@testset "parse_file on missing/malformed input returns C_NULL" begin
